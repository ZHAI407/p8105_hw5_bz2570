...
The raw dataset contains 52179 homicide records and 12 variables. The
data spans from 56920-01-27 to 553688-08-31. Key variables include
victim demographics like *name, age, race, sex*, geographic information
like *city, state, lat, lon*, and *disposition* (which indicates whether

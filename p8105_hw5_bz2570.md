...
0.6456, with a 95% confidence interval of (0.6276, 0.6632).
...
Across all cities, the proportion of unsolved homicides ranges from 0 to
0.7359, with 95% confidence intervals shown in the table above.
